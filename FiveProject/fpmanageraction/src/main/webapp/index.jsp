        ...
        <div class="layui-side-scroll" id="larry-nav-side" lay-filter="side">
            ...
            <ul class="layui-nav layui-nav-tree">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" data-url="/stulist?flag=true">
                                <i class="iconfont icon-zhuti"  data-icon='icon-zhuti'></i>
                                <span>学员缴费</span>
                            </a>
                        </dd>
                        <dd>
                            <a href="javascript:;" data-url="/stafflist?flag=true">
                                <i class="iconfont icon-zhuti"  data-icon='icon-zhuti'></i>
                                <span>员工工资</span>
                            </a>
                        </dd>
                        <dd>
                            <a href="javascript:;" data-url="/view/finance/dayslist.jsp">
                                <i class="iconfont icon-zhuti"  data-icon='icon-zhuti'></i>
                                <span>日收入</span>
                            </a>
                        </dd>
                        <dd>
                            <a href="javascript:;" data-url="/view/finance/monthslist.jsp">
                                <i class="iconfont icon-zhuti"  data-icon='icon-zhuti'></i>
                                <span>月收入</span>
                            </a>
                        </dd>
                        <dd>
                            <a href="javascript:;" data-url="/view/finance/alllist.jsp">
                                <i class="iconfont icon-zhuti"  data-icon='icon-zhuti'></i>
                                <span>总收入</span>
                            </a>
                        </dd>
        ...
        <div class="layui-tab layui-tab-card larry-tab-box" id="larry-tab" lay-filter="demo" lay-allowclose="true">
            ...
            <div class="layui-tab-content" style="min-height: 150px; ">
                <div class="layui-tab-item layui-show">
                    <iframe class="larry-iframe" data-id='0' src="/main1.html"></iframe>
                </div>
            </div>
        </div>
    </div>
