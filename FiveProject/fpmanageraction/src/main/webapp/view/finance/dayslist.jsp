    ...
    <div class="larry-personal">
        <div class="layui-tab">
            <blockquote class="layui-elem-quote news_search">
                <form id="subform" action="/stulist?flag=false" method="post">
                    <div class="layui-inline">
                        <div class="layui-input-inline">
                            <input name="year" placeholder="请输入年份" class="layui-input search_input" type="text">
                            <input name="month" placeholder="请输入月份" class="layui-input search_input" type="text">
                        </div>
...
<table border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
        <td align="center" style="font-size: 14px">
            ...
            <span>
        <c:set var="page" value="${pageContext.request.contextPath }/stulist?currentPage="></c:set>
